        ...
        child: Column(
          children: [
            Container(
              ...
              child: widget.label != "Specialization" ? TextFormField(
                controller: _textcontroller,
                style: GoogleFonts.lato(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                ),
                readOnly: (widget.label == "Id" || widget.label == "Rating" || widget.label == "Type") ? true : false,
                ...
                child: DropdownButton(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem<String>(
                      ...
                      DropdownMenuItem<String>(
                      value: "Eye Special",
                      child: Text("Eye Special")
                      ),
                      DropdownMenuItem<String>(
                      value: "Orthopaedic",
                      child: Text("Orthopaedic")
                      ),
                      DropdownMenuItem<String>(
                      value: "Paediatrician",
